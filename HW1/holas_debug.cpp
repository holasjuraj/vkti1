...
int main(){
    ...
    for(int swap_count = 0; swap_count < m; swap_count++){
        ...
        cout << "card_val1=" << card_val1 << " idx1=" << idx1 << " iter1->second=" << iter1->second << endl;
        ...
        cout << "card_val2=" << card_val2 << " idx2=" << idx2 << " iter2->second=" << iter2->second << endl;
        ...
        cout << "indexes[" << card_val1 << "]=" << indexes[card_val1] << endl;
        cout << "indexes[" << card_val2 << "]=" << indexes[card_val2] << endl;
    }    
    // finalize
    map<int, int> values;
